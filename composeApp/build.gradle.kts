...
android {
    ...
    defaultConfig {
        ...
        applicationId = "ru.ispu.referal.androidApp"
        versionCode = 1
        versionName = "1.0.0"
...
compose.desktop {
    application {
        ...
        nativeDistributions {
            ...
            packageName = "ru.ispu.referal.desktopApp"
...
sqldelight {
    databases {
        create("MyDatabase") {
            ...
            packageName.set("ru.ispu.referal.db")
        }
    }
}
...
apollo {
    service("api") {
        ...
        packageName.set("ru.ispu.referal.graphql")
    }
}
